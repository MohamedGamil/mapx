    ...
    tools: [
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            term: { type: 'string', description: 'Symbol name or pattern to search for' },
            kind: { type: 'string', description: 'Filter by symbol kind (case-insensitive: class, method, function, interface, trait, constant, enum, property, namespace, struct, module)' },
